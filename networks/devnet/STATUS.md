...
| Address prefix `ark` and token `espees` (`aespees` base) live in `MsgSend` | PASS | transaction confirmed against the running devnet |
...
- Denom: `espees` (18-decimal base unit `aespees`; `1 espees = 10^18 aespees`)
- Symbol: `ESP`
